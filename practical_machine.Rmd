...
Introduciton: We aim to predict what type of exercise participants are working on based off of trininag data.
...
Clean the data: Need to see where there are NA values in columns and remove them
